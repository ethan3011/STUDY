...
public class BookApp {
	...
	private void displayAllBooks() {
		...
		System.out.println("====================================================================");
		for (Book book : books) {
			System.out.println(book.getNo() + "\t" + df.format(book.getPrice()) + "\t"
					+ df.format(book.getDiscountPrice()) + "\t" + book.getStock() + "\t" + book.getTitle());
		}
		System.out.println("====================================================================");
	}
	...
	private void admin() {
		boolean isAdminLogined = service.isAdminLogined();
		if (isAdminLogined) {
			while (true) {
				System.out.println("-----------------------------------------------------------------------");
	...
	private void displayMyInfo() {
		...
		System.out.println(
				user.getId() + "\t" + user.getName() + "\t" + user.getGrade() + "\t" + df.format(user.getPoint()));
	}
